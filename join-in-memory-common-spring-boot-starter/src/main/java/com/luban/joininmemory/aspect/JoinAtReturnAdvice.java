package com.luban.joininmemory.aspect;

import cn.hutool.core.util.StrUtil;
import com.luban.joininmemory.JoinService;
import com.luban.joininmemory.annotation.JoinAtReturn;
...
public class JoinAtReturnAdvice {
    ...
    @Pointcut(value = "@annotation(com.luban.joininmemory.annotation.JoinAtReturn)")
