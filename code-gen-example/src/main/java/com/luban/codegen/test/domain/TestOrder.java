 ...
 * @author hp
 */
@GenFeign(pkgName = "com.luban.codegen.test.api", serverName = "orderServer")
@GenRequest(pkgName = "com.luban.codegen.test.domain.request")
@GenCreateRequest(pkgName = "com.luban.codegen.test.domain.request")
@GenUpdateRequest(pkgName = "com.luban.codegen.test.domain.request")
@GenPageRequest(pkgName = "com.luban.codegen.test.domain.request")
@GenResponse(pkgName = "com.luban.codegen.test.domain.response")
@GenPageResponse(pkgName = "com.luban.codegen.test.domain.response")
@GenEvent(pkgName = "com.luban.codegen.test.domain.events")
@GenVo(pkgName = "com.luban.codegen.test.domain.request")
@GenDto(pkgName = "com.luban.codegen.test.domain.response")
