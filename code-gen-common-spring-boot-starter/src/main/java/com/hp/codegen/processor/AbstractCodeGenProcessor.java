...
import com.hp.codegen.processor.api.GenFeignProcessor;
import com.hp.codegen.processor.command.create.GenCreateCommand;
import com.hp.codegen.processor.command.create.GenCreateCommandProcessor;
import com.hp.codegen.processor.command.update.GenUpdateCommand;
import com.hp.codegen.processor.command.update.GenUpdateCommandProcessor;
import com.hp.codegen.processor.context.create.GenCreateContext;
import com.hp.codegen.processor.context.create.GenCreateContextProcessor;
import com.hp.codegen.processor.context.update.GenUpdateContext;
import com.hp.codegen.processor.context.update.GenUpdateContextProcessor;
...
import com.hp.codegen.processor.dto.jpa.GenDtoProcessor;
import com.hp.codegen.processor.event.GenEvent;
import com.hp.codegen.processor.event.GenEventListener;
import com.hp.codegen.processor.event.GenEventListenerProcessor;
...
import com.hp.codegen.processor.repository.jpa.GenRepositoryProcessor;
import com.hp.codegen.processor.request.*;
import com.hp.codegen.processor.response.GenPageResponse;
import com.hp.codegen.processor.response.GenPageResponseProcessor;
...
import com.hp.codegen.processor.service.jpa.GenServiceImplProcessor;
import com.hp.codegen.processor.service.jpa.GenServiceProcessor;
...
public abstract class AbstractCodeGenProcessor implements CodeGenProcessor {
    ...
    private DefaultNameContext createNameContext(TypeElement typeElement) {
        ...
        final String feignName =  typeElement.getSimpleName()  + GenFeignProcessor.FEIGN_SUFFIX;

        final String serviceName = GenServiceProcessor.SERVICE_PREFIX + typeElement.getSimpleName() + GenServiceProcessor.SERVICE_SUFFIX;
        final String implName = typeElement.getSimpleName() + GenServiceImplProcessor.IMPL_SUFFIX;
        final String repositoryName = typeElement.getSimpleName() + GenRepositoryProcessor.REPOSITORY_SUFFIX;

        final String mapperName = typeElement.getSimpleName() + GenMapperProcessor.SUFFIX;

        final String voName = typeElement.getSimpleName() + GenVoProcessor.SUFFIX;
        final String dtoName = typeElement.getSimpleName() + GenDtoProcessor.SUFFIX;

        final String responseName = typeElement.getSimpleName() + GenResponseProcessor.RESPONSE_SUFFIX;
        final String pageResponseName = typeElement.getSimpleName() + GenPageResponseProcessor.RESPONSE_SUFFIX;

        final String requestName = typeElement.getSimpleName() + GenRequestProcessor.SUFFIX;
        final String createRequestName = typeElement.getSimpleName() + GenCreateRequestProcessor.SUFFIX;
        final String updateRequestName = typeElement.getSimpleName() + GenUpdateRequestProcessor.SUFFIX;
        final String pageRequestName = typeElement.getSimpleName() + GenPageRequestProcessor.SUFFIX;

        final String controllerName = typeElement.getSimpleName() + GenControllerProcessor.CONTROLLER_SUFFIX;

        final String createContextName = GenCreateContextProcessor.PREFIX + typeElement.getSimpleName() + GenCreateContextProcessor.SUFFIX;
        final String createCommandName = GenCreateCommandProcessor.PREFIX + typeElement.getSimpleName() + GenCreateCommandProcessor.SUFFIX;
        final String updateContextName = GenUpdateContextProcessor.PREFIX + typeElement.getSimpleName() + GenUpdateContextProcessor.SUFFIX;
        final String updateCommandName = GenUpdateCommandProcessor.PREFIX + typeElement.getSimpleName() + GenUpdateCommandProcessor.SUFFIX;

        final String eventName = typeElement.getSimpleName() + GenEventProcessor.SUFFIX;
        final String eventListenerName = typeElement.getSimpleName() + GenEventListenerProcessor.SUFFIX;
